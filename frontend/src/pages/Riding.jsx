...
const Riding = () => {
  ...
  const { socket } = useContext(SocketContext)
    ...
    console.log(rideData,"user riding page")
        ...
        <div className='h-1/2 p-4'>
             ...
             <div className='flex items-center justify-between'>
                ...
                <div className='text-right'>
                    ...
                    <h2 className='text-xl font-semibold -mt-1 -mb-1'>{rideData?.driver?.fullname.firstname}</h2>
                ...
                <div className='w-full mt-5'>
                    <div className='flex items-center gap-6 p-4 border-b-2 '>
                        ...
                        <div>
                            ...
                            <p className='text-base text-gray-600 -mt-1'>{rideData?.dropoff}</p>
                        </div>
                    </div>
