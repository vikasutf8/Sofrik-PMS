...
const RidePopUp = ({ setRidePopUpPanel,setConfirmRidePopUp,ride, confirmRide }) => {
    console.log(ride,"ride pop up component")
    return (
        <div >
            <h5
            ...
            <div className='flex justify-between items-center p-2 bg-amber-200 rounded-2xl  '>
                <div className='flex justify-start items-center gap-4'>
                    ...
                    <h4 className='text-lg font-medium'>{ride?.user?.fullname.firstname || "Driver"}</h4>
                </div>
                <h5>4.5 KM</h5>
            </div>
                ...
                <div className='w-full mt-3'>
                    <div className='flex items-center gap-6 p-4 border-b-2 '>
                        ...
                        <div>
                            ...
                            <p className='text-base text-gray-600 -mt-1'>{ride?.pickup || "Pickup"}</p>
                        </div>
                    </div>
                    <div className='flex items-center gap-6 p-4 border-b-2 '>
                        ...
                        <div>
                            ...
                            <p className='text-base text-gray-600 -mt-1'>{ride?.dropoff || "Dropoff"}</p>
                        </div>
                    </div>
